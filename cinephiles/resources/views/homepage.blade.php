...
<body>
            ...
            <div class="row">
               <div class="col-sm-12">
                  <nav class="navbar navbar-expand-lg navbar-light p-0">
                     ...
                     <a class="navbar-brand" href="index.html"> <img class="img-fluid logo" src="images/logo.png" alt="streamit" /> </a>
   ...
   <section id="home" class="iq-main-slider p-0">
      <div id="home-slider" class="slider m-0 p-0">
         ...
         <div  style="background-image:url(images/{{$i->image}}); object-fit:cover; background-repeat:no-repeat" >
               ...
               <div class="slider-inner h-100">
                  <div class="row align-items-center  h-100">
                     <div class="col-xl-6 col-lg-12 col-md-12">
                        ...
                        <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft" data-delay-in="0.6">{{$i->movie_name}}</h1>
                        ...
                        <p data-animation-in="fadeInUp" data-delay-in="1.2">{{$i->synopsis}}
                        </p>
                        <div class="trending-list" data-wp_object-in="fadeInUp" data-delay-in="1.2">
                           ...
                           <div class="text-primary title genres">
                              Genres: <span class="text-body">{{$i->genres}}</span>
                           </div>
                  ...
                  <div class="col-xl-5 col-lg-12 col-md-12 trailor-video">
                     <a href="video/{{$i->movie_clip}}" class="video-open playbtn">
