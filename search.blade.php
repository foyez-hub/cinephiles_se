            ...
            success: function(data) {
                ...
                $.each(data[0], function(key, value) {
                    html +=
                        ...
                        '<button style="color:#4dbf00;" onclick="show(\'' + value.movie_name + '\')" class="cross-button mr-2"><i class="fas fa-eye"></i></button>' +
                        '</div>' +
                        '</div>' +
                        '</div>';
                ...
                $.each(data[1], function(key, value) {
                    html +=
                        ...
                        '<div class="item-description opacity-none  row justify-content-center">' +
                        '<button style="color:#4dbf00;" class="cross-button mr-2" onclick="viewprofile(\'' + value.email + '\')" ><i class="fas fa-user"></i></button>' +
                        '</div>' +
                        '</div>' +
                        '</div>';
