...
<div style="background-color:#212529; border: 5px solid #4dbf00;" id="friendlist">
    ...
    <ul id="friends">
        <li>
            <img  style=" border: 2px solid #4dbf00;" src="https://via.placeholder.com/50x50.png?text=Profile+Pic" alt="Profile Picture">
            <span>John Doe</span>
            <button>Add</button>
        </li>
            ...
            success: function(data) {
                ...
                $.each(data[1], function(key, value) {
                    html +=
                        ...
                        '<div class="item-description opacity-none row justify-content-center"><button style="color:#4dbf00;" onclick="show(\'' + value.movie_name + '\')" class="cross-button mr-2"><i class="fa fa-info-circle"></i></button><button style="color:#4dbf00;" class="add-button" onclick="remove(\'' + value.movie_name + '\', \'watchlist\')"><i class="fas fa-minus"></i></button></div>' +
                        "</div>" +
                        "</div>";
                });
                ...
                $.each(data[3], function(key, value) {
                    html +=
                        ...
                        '<div class="item">' +
                        '<img class="item-image" src="images/' + value.image + '" />' +
                        '<div class="item-description opacity-none row justify-content-center"><button style="color:#4dbf00;" onclick="show(\'' + value.movie_name + '\')" class="cross-button mr-2"><i class="fa fa-info-circle"></i></button><button style="color:#4dbf00;" class="add-button" onclick="remove(\'' + value.movie_name + '\', \'favorites\')"><i class="fas fa-minus"></i></button></div>' +
                        "</div>" +
                        "</div>";
                });
                ...
                $.each(data[2], function(key, value) {
                    html +=
                        ...
                        '<div class="item">' +
                        '<img class="item-image" src="images/' + value.image + '" />' +
                        '<div  class="item-description opacity-none row justify-content-center"><button style="color:#4dbf00;" onclick="show(\'' + value.movie_name + '\')" class="cross-button mr-2"><i class="fa fa-info-circle"></i></button><button style="color:#4dbf00;" class="add-button" onclick="remove(\'' + value.movie_name + '\', \'recent\')"><i class="fas fa-minus"></i></button></div>' +
                        "</div>" +
                        "</div>";
                });
