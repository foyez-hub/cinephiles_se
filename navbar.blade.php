...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  ...
  <a class="navbar-brand " href="#"><h1 class="logoName">Cinephiles</h1></a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link navlink" href="#">Meme</a>
      </li>
      <li class="nav-item">
        <a class="nav-link navlink" href="search">About</a>
      </li>
    ...
    <div class="input-group ">
      <input class="form-control searchInputField" type="search" placeholder="Search" aria-label="Search">
      <button class="btn  searchButton my-2 my-sm-0 mr-lg-4 searchButtonDesign " type="submit"><i class="fas fa-search"></i></button>
    </div>
...
<div style="background-color:#212529; border: 5px solid #4dbf00;" id="friendlist1">
  <h2 style="color:#f1f1f1"; >Friend requests</h2>
  <ul id="friends1">
    <li>
