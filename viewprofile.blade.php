            ...
            success: function(data) {
                ...
                $.each(data[1], function(key, value) {
                    html +=
                        ...
                        '<div class="item-description opacity-none row justify-content-center"><button onclick="show(\'' + value.movie_name + '\')" class="cross-button mr-2"><i class="fa fa-info-circle"></i></button></div>' +
                        "</div>" +
                        "</div>";
                });
