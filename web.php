...
Route::get('/topmeme', [MemeController::class,'topmeme']);
...
Route::post('/moviestore', [adminController::class,'moviestore']);



Route::post('/setContest', [adminController::class,'setContest']);
Route::get('/gettime', [MemeController::class,'gettime']);

Route::get('/Endcontest', [MemeController::class,'Endcontest']);
Route::post('/addrecent', [profileController::class,'addrecent']);
